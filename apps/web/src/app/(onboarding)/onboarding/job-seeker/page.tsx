...
import type { CreateJobSeekerInput, PersonalDetailsInput } from "@vittamhub/types";
import { useEffect, useState } from "react";

import { WizardShell, type WizardStepMeta } from "@/components/onboarding/WizardShell";
import { JobSeekerInfoStep } from "@/components/onboarding/role-steps/JobSeekerInfoStep";
...
const STEPS: WizardStepMeta[] = [
  ...
  { id: "job-seeker-info", label: "Career profile" },
];
...
export default function JobSeekerOnboardingPage() {
  ...
  return (
    <WizardShell steps={STEPS} currentStepIndex={step} onStepSelect={setStep}>
      ...
      {step === 1 && (
        <JobSeekerInfoStep defaultValues={draftSection<CreateJobSeekerInput>(draft, "jobSeekerInfo")} onBack={goBack} />
      )}
    </WizardShell>
  );
}
